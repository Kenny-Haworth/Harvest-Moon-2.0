...
var grid_size = Vector2(18, 18) #18 tiles x 18 tile
var tile_size = Vector2(48, 48) #48 pixels x 48 pixels
...
func _ready():
	...
	#assert (Background.get_cell_size() == Objects.get_cell_size() and Objects.get_cell_size() == Dirt.get_cell_size() and Dirt.get_cell_size() == Crops.get_cell_size())
...
func sleep():
	for x in range(grid_size.x):
		for y in range(grid_size.y):
			if Objects.get_cell(x,y) == 5:
				Objects.set_cellv(Vector2(x, y), 1)
			elif Objects.get_cell(x,y) == 1:
				Objects.set_cellv(Vector2(x, y), 5)
...
func spread_seeds(pos):
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x+tile_size.x, pos.y)), 5)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x-tile_size.x, pos.y)), 5)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x, pos.y+tile_size.x)), 5)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x, pos.y-tile_size.x)), 5)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x+tile_size.x, pos.y+tile_size.x)), 5)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x+tile_size.x, pos.y-tile_size.x)), 5)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x-tile_size.x, pos.y+tile_size.x)), 5)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x-tile_size.x, pos.y-tile_size.x)), 5)
...
func swing_hoe(pos, orientation):
	...
	Objects.set_cellv(Objects.world_to_map(pos), -1)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x+x1,pos.y+y1)), -1)
	Objects.set_cellv(Objects.world_to_map(Vector2(pos.x+x2,pos.y+y2)), -1)
...
func water_square(pos, orientation):
	...
	Objects.set_cellv(Objects.world_to_map(pos), 5)